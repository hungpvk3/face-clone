...
const CreatePost = () => {
    return (
        <div className="create-group-container">
            <div className="create-group-something">
                <img
                ...
                <div className="create-group-something-button">
                    Hùng ơi, bạn đang nghĩ gì thể?
                </div>
            </div>

            <div className="create-group-line" />

            <div>
                <ul className="create-group-enmoje">
                    <li className="create-group-enmoje-item">
                        <svg
                            viewBox="0 0 24 24"
                            width="1em"
                            height="1em"
