    ...
    return (
        <div className="">
            ...
            <div className="flex items-center gap-3 p-1.5 bg-blue-50 rounded-md mt-4 mb-2.5 mx-2">
                ...
                <i data-visualcompletion="css-img" className="hu5pjgll eb18blue" style={{backgroundImage: "url('https://static.xx.fbcdn.net/rsrc.php/v3/y_/r/TpmAno71g1z.png')", backgroundPosition: '0px -732px', backgroundSize: '33px 921px', width: '20px', height: '20px', backgroundRepeat: 'no-repeat', display: 'inline-block'}}></i>
                </div>
