...
const VideoPage = () => {
    return (
        ...
        <div className=" mt-3 flex items-center bg-white rounded-lg shadow md:hidden">
        <div className="flex flex-1 items-center justify-center gap-3 p-2 rounded-lg my-1.5 mx-2 cursor-pointer hover:bg-blue-50 ">
