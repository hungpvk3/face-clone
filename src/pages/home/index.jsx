      ...
      <div className="home-container">
        ...
        <div className="home-main">
          ...
          <div className="home-posts">
            <PostItem imgPost={stories1} avatar={user?.firstName} link={1} />
            <PostItem imgPost={stories1} avatar={user?.firstName} link={2} />
            <PostItem imgPost={stories1} avatar={user?.firstName} link={3} />
          </div>
        </div>
