...
const Messenger = ({ isOpen, onOpenMesModal }) => {
    return (
        ...
        >
            <div className="">
                <div className="header-mes flex items-center justify-between">
                    <h2 className="text-2xl font-bold">Messenger</h2>
                    <div>
                        <Zoom />
                    </div>
                </div>
                <div htmlFor="search" className="messenger-modal-searchs">
                    <span className="messenger-modal-icon">
                        <svg
                            viewBox="0 0 16 16"
                            width="1em"
                            height="1em"
                    ...
                    <input
                        ...
                        className="messenger-modal-search"
                    />
                </div>
            </div>
            <div
