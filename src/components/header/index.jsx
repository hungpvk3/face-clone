...
import { MesIcon, Bell, Arow, Task } from "../icons";
    ...
    return (
        <div className="header-container">
            <div className="header-left">
                ...
                <div htmlFor="search" className="header-searchs">
                    <span className="header-searchs-icon">
                        <svg
                            viewBox="0 0 16 16"
                            width="1em"
                            height="1em"
            ...
            <ul className="header-main">
                ...
                <li className={`header-main-item`}>
                    ...
                    <div
                        className={`header-line ${
                            path === "marketplace" ? "active-line" : ""
                        }`}
                    ></div>
                </li>
                <Link to="/groups/feel" className={`header-main-item ${
                        path === "groups" ? "active-item" : ""
                    }`}>
                    <svg
                        viewBox="0 0 28 28"
                        className="a8c37x1j ms05siws hwsy1cff b7h9ocf4 em6zcovv"
                ...
                <li className={"header-main-item"}>
                    <Link to="bookmarks">
                        <Task
                            css={`
                                ${path === "bookmarks" ? "fill-blue-700" : ""}
                            `}
                        />
                    </Link>
                    <div
                        className={`header-line ${
                            path === "bookmarks" ? "active-line" : ""
                        }`}
                    ></div>
                </li>
            </ul>
            ...
            <div className="header-right">
                ...
                >
                    ...
                    />
                    <span className="header-info-name">Hùng</span>
                </Link>
                ...
                <ul className="header-noti">
                    ...
                    <li>
                        <div className="header-noti-item">
                            <Bell />
                        </div>
